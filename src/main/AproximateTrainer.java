...
public class AproximateTrainer {
    ...
    public static void main(String[] args) {
        ...
        for(int cpt = 1; cpt < 10000000; cpt++) {
            ...
            System.out.println("==== W1 : " + Arrays.toString(arrayStrategies[0].getW()));
            System.out.println("==== W2 : " + Arrays.toString(arrayStrategies[1].getW()));
